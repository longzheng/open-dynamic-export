...
export function getMeterMetrics(meter: MeterModel) {
    ...
    const scaledValues = {
        ...
        PPV: numberNullableWithPow10(meter.PPV, meter.W_SF),
        PPVphAB: numberNullableWithPow10(meter.PPVphAB, meter.W_SF),
        PPVphBC: numberNullableWithPow10(meter.PPVphBC, meter.W_SF),
        PPVphCA: numberNullableWithPow10(meter.PPVphCA, meter.W_SF),
