    ...
    for (const controlLimit of controlLimits) {
        ...
        if (controlLimit.batteryStorageMode !== undefined) {
            ...
            if (
                ...
                (batteryStorageMode.value === 'charge' &&
                    controlLimit.batteryStorageMode !== 'charge') ||
                (batteryStorageMode.value === 'discharge' &&
                    controlLimit.batteryStorageMode === 'hold')
            ) {
                batteryStorageMode = {
                    source: controlLimit.source,
        ...
        if (controlLimit.batteryTargetSocPercent !== undefined) {
            if (
                ...
                // take the lesser value (most restrictive)
                controlLimit.batteryTargetSocPercent <
                    batteryTargetSocPercent.value
            ) {
                batteryTargetSocPercent = {
                    source: controlLimit.source,
        ...
        if (controlLimit.batteryImportTargetWatts !== undefined) {
            if (
                ...
                // take the lesser value (most restrictive)
                controlLimit.batteryImportTargetWatts <
                    batteryImportTargetWatts.value
            ) {
                batteryImportTargetWatts = {
                    source: controlLimit.source,
        ...
        if (controlLimit.batteryPriorityMode !== undefined) {
            if (
                ...
                (batteryPriorityMode.value === 'export_first' &&
                    controlLimit.batteryPriorityMode === 'battery_first')
            ) {
                batteryPriorityMode = {
                    source: controlLimit.source,
